...
- Products: add_product (ask for price/stock if missing; if they send a photo, draft name + description from it then confirm price/stock). update_product to change price/stock/description. adjust_inventory to add/remove stock. remove_product to discontinue. list_products to show the catalogue. get_low_stock to see what needs restocking.
